...
void AnswerIO::WriteToFile(std::string out_file, Validatable *sudoku) {
...
void AnswerIO::ReadFromFile(std::string input_file, Validatable *&ret) {
    SudokuAnswer *tmp = new SudokuAnswer;
